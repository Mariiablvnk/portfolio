					...
					<div className="header-nav">
						...
						<div ref={menuRef} className={`nav-box ${isMenuOpen ? 'show' : ''}`}>
							<ul className="nav">
								...
								<li className="nav-item">
									<Link className="nav-link" href="/#services"><i className="bi bi-arrow-right"></i>Work Experience</Link>
								</li>
								<li className="nav-item">
									<Link className="nav-link" href="/#portfolio"><i className="bi bi-arrow-right"></i>Projects</Link>
								</li>
