            ...
            <div className="row g-4 g-md-5">
                ...
                <div className="col-12 col-md-12 col-lg-4 order-lg-3 text-lg-end">
                    <div className="row g-4 g-lg-5">
                        ...
                        <div className="col-4 col-lg-12">
                            <h6 className="sm-heading">Current Position</h6>
                            <p>{aboutData.mainData.experience} <a style={{color: '#ff82f3'}} className='font-[#ff82f3]' href="portfolio/second">Negombo Park</a></p>
                        </div>
